...
@section('content')
    ...
    >
        <div
            ...
            style='background-image: url({{ url("assets/images/backgrounds/background2.jpg")  }});'
        >
          <span
              id="blackOverlay"
        ...
        <div class="container relative mx-auto">
            <div class="items-center flex flex-wrap">
                <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                    <div class="pr-12">
                        <h1 class="flex justify-center items-center text-white font-semibold text-5xl">
                            <img src="{{ url('assets/images/logo/logo-orange-sm.png') }}" alt="" class="h-10 mr-2">
                            Fitae Club
                        </h1>
                        <p class="mt-4 text-lg text-gray-300">
                            Une offre spécialement conçue pour les clubs ambitieux.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-center text-center mb-24">
                <div class="w-full lg:w-6/12 px-4">
                    <h2 class="text-4xl font-semibold">Ils nous font déjà confiance</h2>
                    <p class="text-lg leading-relaxed m-4 text-gray-600">
                        "J'a terminé ma préparation physique en Juillet, et j'ai commencé la saison à 100% de mes capacités."<br />Tom Thibault - Régional 1
                    </p>
                </div>
            </div>
            <div class="flex flex-wrap justify-center">
                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                    <div class="px-6">
                        <img
                            alt="breuil-magne-fc-logo"
                            src="{{ url('assets/images/clubs/bmfc.png') }}"
                            class="shadow-lg rounded-full max-w-full mx-auto"
                            style="max-width: 120px;"
                        />
                        <div class="pt-6 text-center">
                            <h5 class="text-xl font-bold">Breuil-Magné FC</h5>
                ...
                <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                    <div class="px-6">
                        <img
                            alt="..."
                            src="{{ url('assets/images/clubs/rfc.png') }}"
                            class="shadow-lg rounded-full max-w-full mx-auto"
                            style="max-width: 120px;"
                        />
                        <div class="pt-6 text-center">
                            <h5 class="text-xl font-bold">Rochefort FC</h5>
                            <p class="mt-1 text-sm text-gray-500 uppercase font-semibold">
                                Regional 2
                            </p>
                            <div class="mt-6">
