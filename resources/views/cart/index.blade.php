                ...
                <div class="flex-1">
                        ...
                        @foreach(Cart::content() as $product)
                            <tr>
                                <td class="hidden pb-4 md:table-cell">
                                    <a href="#">
                                        <img src="{{ $product->model->image }}" class="w-20 rounded" alt="Thumbnail">
                                    </a>
                                </td>
                                <td>
                                    <a href="#">
                                        ...
                                        <form action="{{ route('cart.destroy', $product->rowId) }}" method="POST">
                                            ...
                                            <button type="submit" class="text-gray-700 md:ml-4">
                                                <small class="flex">Supprimer
                                                    <svg aria-hidden="true" data-prefix="far" data-icon="trash-alt" class="w-3 text-red-600 hover:text-red-800 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                ...
                                <td class="hidden text-right md:table-cell">
                                    <span class="text-sm lg:text-base font-medium">{{ $product->model->getPrice() }}</span>
                                </td>
                                <td class="text-right">
                                    <span class="text-sm lg:text-base font-medium">{{ $product->model->getPrice() }}</span>
                                </td>
                    ...
                    <div class="my-4 mt-6 -mx-2 lg:flex">
                        <div class="lg:px-2 lg:w-1/2">
                            ...
                            <div class="p-4">
                                <p class="mb-4 italic">Si vous possédez un coupon de réduction, entrez le juste en
                                    dessous</p>
                        ...
                        <div class="lg:px-2 lg:w-1/2">
                            <div class="p-4 bg-gray-100 rounded-full">
                                <h1 class="ml-2 font-bold uppercase">Détail de la commande</h1>
                            </div>
                            <div class="p-4">
                                <p class="mb-6 italic">Les frais d'expédition et les frais supplémentaires sont calculés sur
                                    la base des valeurs que vous avez saisies</p>
